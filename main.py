...
with open('ingredients.csv', 'w', encoding='UTF8') as ingredientscsv:
    ...
    with open('OpenFoodFactsDatabase.csv', newline='') as originalcsv:
        ...
        for row in reader:
            ...
            lambda x: x.group().replace(',', ';'),ingredients)
...
with open('ironferroussulfate.csv', 'w',
          encoding='UTF8') as ironferroussulfatecsv:
    ...
    with open('ingredients.csv', 'r', newline='') as ingredientscsv:
        ...
        for row in reader2:
            ...
            if row['ingredients'].find("IRON") != -1 or row['ingredients'].find(
                    "Iron") != -1 or row['ingredients'].find(
                        "iron") != -1 or row['ingredients'].find(
                            "Ferrous Sulfate"
                        ) != -1 or row['ingredients'].find(
                            "FERROUS SULFATE") != -1 or row[
                                'ingredients'].find("ferrous sulfate") != -1:
...
with open('ironferroussulfate.csv', 'r', newline='') as ironferroussulfatecsv:
    ...
    for row in reader3:
      ...
      #searching for the various formatting differences and counting them
...
print("The count of \"Iron\" is: " +
      str(countofIron - countofironferroussulfate2 - countofReducedIron))

#subtracting countofIRONFERROUSSULFATE and countofferroussulfateiron4 because...
#although the term "IRON" is in it, the instances of IRON are when the ingredient is listed as "IRON"
print("The count of \"IRON\" is: " +
      str(countofIRON - countofIRONFERROUSSULFATE -
          countofferroussulfateiron4))

#subtracting countofreducediron,countofironferroussulfate,countofelectrolyticiron, and countofferroussulfateiron because...
#although the term "Iron" is in it..the instances of "iron" are when the ingredient is listed as "iron"
print("The count of \"iron\" is: " +
      str(countofiron - countofreducediron - countofironferroussulfate -
          countofelectrolyticiron - countofferroussulfateiron))
...
print("The count of \"iron (ferrous sulfate)\" is: " +
      str(countofironferroussulfate))

print("The count of \"IRON (FERROUS SULFATE)\" is: " +
      str(countofIRONFERROUSSULFATE))

print("The count of \"Iron [Ferrous Sulfate]\" is: " +
      str(countofironferroussulfate2))
...
print("The count of \"ferrous sulfate\" is: " +
      str(countofferroussulfate - countofironferroussulfate -
          countofferroussulfateiron - countofferroussulfateiron2 -
          countofferroussulfateiron3))
...
print("The count of \"ferrous sulfate {iron}\" is: " +
      str(countofferroussulfateiron))

print("The count of \"ferrous sulfate(iron)\" is: " +
      str(countofferroussulfateiron2))

print("The count of \"ferrous sulfate [iron]\" is: " +
      str(countofferroussulfateiron3))

print("The count of \"FERROUS SULFATE [IRON]\" is: " +
      str(countofferroussulfateiron4))
